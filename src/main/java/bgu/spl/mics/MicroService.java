...
public abstract class MicroService implements Runnable {
    ...
    protected static MessageBusImpl msgBus;
    Map<Class<? extends Message>, Callback> messagesCallback;
    ...
    protected final <T, E extends Event<T>> void subscribeEvent(Class<E> type, Callback<E> callback) {
        messagesCallback.put(type, callback);
    ...
    protected final <T> Future<T> sendEvent(Event<T> e) {
        Future<T> ft = msgBus.sendEvent(e);
        return ft;
    }
    ...
    public final void run() {
        ...
        while (!terminated) {
            try{
                ...
                messagesCallback.get(msg.getClass()).call(msg);
